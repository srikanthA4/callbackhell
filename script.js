                      ...
                      four(() => {
                          three(() => {
                              two(() => {
                                  one(() => {
                                      setTimeout(() =>{
                                          document.getElementById("myid").innerHTML = "Many  More  Happie return  of  the   day maghana reddy be  happy  with   lots  of  love❤️❤️❤️❤️   and blessings🙌🙌🙌 from your parents and be happy this birthday with your lovely new colleague i hope this birthday will make more fun better than past days   ";
                                     }, 2000);                                        
                                  })
                              })
                          })
